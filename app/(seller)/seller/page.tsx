...
export default async function SellerDashboardPage() {
  ...
  const needsKyc = kycStatus === 'NOT_STARTED' || kycStatus === 'REJECTED' || kycStatus === 'EXPIRED';
      ...
      <main className="flex min-h-screen flex-col bg-obsidian-loam pt-[80px]">
        <div className="mx-auto w-full max-w-4xl space-y-8 px-6 py-12">
            ...
            <div className="rounded-md border border-lime-surveyor/50 bg-lime-surveyor/5 p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-jetbrains-mono text-[13px] text-lime-surveyor">✓ Verified</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {/* New Project CTA */}
            <div className={`rounded-md border ${isApproved ? 'border-iron-filings bg-[#141414]' : 'border-iron-filings/50 bg-[#141414]/50'}`}>
              <div className="p-6">
            ...
            <div className="rounded-md border border-iron-filings bg-[#141414]">
              <div className="p-6">
                ...
                <p className="mt-1 font-jetbrains-mono text-[12px] text-drift-ash">
                  Status:{' '}
                  <span className={
                    kycStatus === 'APPROVED' ? 'text-lime-surveyor' :
