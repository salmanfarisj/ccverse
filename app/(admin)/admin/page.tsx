...
export const metadata = {
  title: 'Admin',
  description: 'KYC review and compliance administration.',
};
...
function AdminCard({
  ...
  return (
    <Link
      href={href}
      className="block rounded-md border border-iron-filings bg-surface-raised p-8 transition-colors hover:border-lime-surveyor !no-underline"
    >
